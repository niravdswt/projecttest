<?php
  include"../action/connect.php";
	...
	$sel="select * from user1 where user_id='".$_GET['task']."'";
...
<form action="edit_action1.php" method="post">
<?php
...
<th>
   ...
   <td>
       <select name="course" >
          <option value="php"<?php if($i['course']=="php"){echo "selected==selected";} ?>>php </option>
          <option value=".net" <?php if($i['course']==".net"){echo "selected==selected";} ?>>.net</option>
          <option value="java"<?php if($i['course']=="java"){echo "selected==selected";} ?>>java</option>
   </td>
...
<tr>
   <th>Fees:</th>
   <td>
      <input type="text" name="fees" value="<?php echo $i['fees'];?>" size="60" />
      </td>
