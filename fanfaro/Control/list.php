...
<div id="container">
    ...
    <div id="body">
      ...
      <form action="../action/delete_all.php" method="post">
      <tr>
         <th><input type="checkbox" name="checkbox" id="checkbox" /></th>
          ...
          <td><input type="checkbox" name="check_all[]" id="check_all" value="<?php echo $user_detail[$i]['user_id'];?>" /></td>
            ...
            <td><?php echo $user_detail[$i]['number'];?></td>
             ...
             <?php $path="../uploade/" ?>
             <td><?php echo $user_detail[$i]['image'];?></td>
             <td><img src="<?php echo $path.$user_detail[$i]['image'];?>" /></td>
            <td><a class="color" href="delete.php?task=<?php echo $user_detail[$i]['user_id'];?>" >Delete</a><td><a class="color" href="edit.php?task=<?php echo $user_detail[$i]['user_id'];?>" >Edit</a>
